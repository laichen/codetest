...
#视频位置
videoinpath  = '/Volumes/XENSERVER-7/铅房U臂/Pb-box-14&7s.mp4'
videooutpath = '/Volumes/XENSERVER-7/铅房U臂/Pb-box-14&7s-new.mp4'
...
#绘图，位移和差分位移
dx = 0.078   # unit:mm/pixel
dy = 0.047  # unit:mm/pixel
